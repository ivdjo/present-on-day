 ...
 * @author Jordy
 */
public class FormDosenLaporanDetailController implements Initializable {

    private Jadwal jadwalSession;
    
    @FXML
    private AnchorPane formDosenLaporanDetail;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(FormDosenLaporanDetailController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
    ...
    private void btnBack(ActionEvent event) throws IOException {
        ...
        sp.switchPane(formDosenLaporanDetail,"formDosenLaporan");
    }
