 ...
 * @author Jordy
 */
public class FormTatapMukaController implements Initializable {

    private Jadwal jadwalSession;
    private Pertemuan pertemuanSession;
    
    @FXML
    private AnchorPane formTatapMuka;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(FormTatapMukaController.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
    ...
    private void btnBack(ActionEvent event) throws IOException {
        ...
        sp.switchPane(formTatapMuka,"formPresensi");
    }
    ...
    @FXML
    private void btnPresensi(ActionEvent event) throws SQLException, IOException {
        PertemuanDAO pertemuanData = new PertemuanDAO();
        ...
        SwitchPane sp = new SwitchPane();
        sp.switchPane(formTatapMuka,"formInputPresensi");
    }
