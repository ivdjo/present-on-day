package com.ivana.presensi.database;
 ...
 * Class to use the functionality of
 * <code>MySqlJdbcUtilities</code>. This class do the following tasks:<br/> 1.
 * Gets the Connection from DBConnection Class<br/> 2. Provides the querying
 * tools to its child classes<br/>This class can also be used to get the meta
 * data of the database.<br/>i.e: the column names from a
 * <code>ResultSet</code> etc
 *
